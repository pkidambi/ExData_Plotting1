...
par(mfrow=c(2,2))
# plot global_active_power vs date_time in grid 1
...
# plot global_reactive_power vs date_time in grid 4
plot(mydata4$date_time, mydata3$Global_reactive_power, type = "l", 
